...
Prior to our exploratory data analysis, we planned to train and test our data using three method: KNN, PLS, and Classification/Regression Trees. Although, after exploring our data further and attempting to run these models, a few key problems came up as to why these don't work well to our training data: 

Extreme Class Imbalance: ???

High-Dimensional Numeric Ratios: ??

Nonlinear Relationships: ???

Overlapping Distributions: ??

Due to the problems listed above, we decided to explore models that would adapt better to the issues we saw in our training set. Those models include Ridge Regression, LASSO, Bagging, and Random Forest. We will further explore those models and their outputs below.
