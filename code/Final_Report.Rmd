...
Across the test set, Ridge achieved an accuracy of 0.8583, a sensitivity of 0.8625, and a specificity of 0.8581. Importantly, Ridge produced an AUC of .9318, indicating excellent ability to rank companies by bankruptcy risk. The model consistently assigns very low probabilities to healthy firms and high probabilities to bankrupt firms, as shown in the validation probability distribution plot.
