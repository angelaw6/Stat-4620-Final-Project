...
The first model that we decided to explore was Ridge Regression. This is useful when we have highly correlated features, high-dimensional predictors, lots of noise, and class imbalance. All of those are characteristics that were noticed in our data exploration. Thus, this felt like a beneficial model to explore.

When we ran this model on our test set of data, these were the results:

```{r}
conf_mat_ridge$table
```

Following that, we got certain metrics such as accuracy, sensitivity, specificity, and AUC. Our accuracy of .8578 indicates that are model got about 86% of the test set correctly classified. Additionally, our sensitivity was .8625, which shows that about 86% of actual bankrupt companies were identified correctly. Next, with a specificity of .8576 means that 86% of non-bankrupt companies were accurate. Finally, having an AUC of .9319 means that the model is very good at separating the positive and negative classes across all possible probability thresholds.
